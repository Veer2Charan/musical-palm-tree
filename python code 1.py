...
label_id = Label(45567834)
label_dob = Label(23/3/23)
label_pin = Label(Htp)
label_address = Label("wingston street")
label_vehicle_type = Label("4 wheeler")
label_name = Label("veer")
